import 'package:diary_sample/ui/entries/add_entry.dart';
import 'package:diary_sample/ui/entries/list_entries.dart';
...
void main() async {
  ...
  ], child: const DiarySample()));
}

class DiarySample extends StatelessWidget {
  const DiarySample({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      initialRoute: '/',
      routes: {'/': (context) => const ListDiary()},
    );
  }
}
